...
- Deployment status: remote D1 migration `0004_scheduled_meetings.sql` applied; Worker deployed as version `c83e53b6-eca7-4b9d-a904-3b746db7a311`; dashboard deployed to `https://77d95a08.frc-attendance-dashboard.pages.dev`.
